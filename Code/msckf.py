...
class MSCKF(object):
    ...
    def batch_imu_processing(self, time_bound):
        ...
        self.imu_msg_buffer = self.imu_msg_buffer[self.used_imu_msg_cntr:]
    ...
    def state_augmentation(self, time):
        ...
        J[3:6, 0:3] = skew(np.matmul(R_w_i_t,t_c_i)) ##(3,3) 3,0
